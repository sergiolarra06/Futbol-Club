...
public class JugadorDAO implements IOperaciones<Jugador, Long> {
    ...
    private static final String SQL_SELECT = "SELECT persona.id, persona.nombre, persona.apellido, persona.fecha_nacimiento, persona.correo\n"
            + "	   	   FROM persona INNER JOIN jugador ON persona.id = jugador.id";
    ...
    @Override
    public void modificar(Jugador o) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void eliminar(Jugador o) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
